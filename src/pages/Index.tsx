...
const animals = [
  ...
  { emoji: "🦔", name: "Ежи", desc: "Пыхтят и топают лапками. Самые милые на свете!", color: "bg-yellow-500" },
];

const services = [
  { icon: "Users", title: "Групповые экскурсии", desc: "Для школ, детских садов и корпоративов. От 10 человек.", price: "от 300 ₽/чел" },
  { icon: "Star", title: "VIP-тур", desc: "Личный гид, все животные, фотосессия. Незабываемо!", price: "от 2 500 ₽" },
  { icon: "Gift", title: "День рождения", desc: "Праздник с животными. Ведущий, торт, фото — всё включено.", price: "от 15 000 ₽" },
