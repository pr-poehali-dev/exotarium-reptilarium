            ...
            {animals.map((a, i) => (
              <Reveal key={i} delay={i * 0.07}>
                ...
                >
                  ...
                  {(a as typeof a & { photos?: string[] }).photos?.map((src, pi) => (
                    <img key={pi} src={src} alt={a.name} style={{ width: "100%", borderRadius: 16, marginBottom: 12, objectFit: "cover", maxHeight: 220 }} />
                  ))}
